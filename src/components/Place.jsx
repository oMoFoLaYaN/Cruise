    ...
    <div key={place.id} className="h-[230px] lg:h-[263px] relative overflow-hidden rounded-md group">
      ...
      <div className="absolute w-full h-full flex flex-col justify-between pt-3 pb-4 px-3 left-0 top-0 text-[color:var(--white-color)]">
        ...
        <div className="place__data">
          <h3 className="text-[length:var(--h3-font-size)] mb-2 text-[color:var(--white-color)]">{place.name}</h3>
      ...
      <button className={`inline-block rounded-tl-md bg-[color:var(--first-color)] text-[color:var(--white-color)] font-medium duration-300  hover:bg-[color:var(--first-color-alt)] items-center gap-x-1 absolute px-4 py-3 right-0 bottom-0`}>
