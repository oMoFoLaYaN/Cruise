       ...
       <div className="grid-cols-[repeat(auto-fit,minmax(220px,1fr))] gap-y-8 lg:justify-items-center grid gap-6 ">
            <div className="footer__data">
              ...
              <p className="footer__description mb-8">
                Cruise, You choose the <br /> destination, we offer you the{" "}
                <br /> experience.
              </p>
              <div>
                <Social color="text-xl text-water-700 dark:text-water-100 mr-5" />
              </div>
            </div>

            {footerLinks.map((footerlink) => (
              <div key={footerlink.title} className="footer__data">
                <h3 className="footer__subtitle mb-4 text-[length:var(--h3-font-size)]">
                  {footerlink.title}
                </h3>
                <ul>
                  {footerlink.links.map((link, index) => (
                    <li key={link.name} className="footer__item mb-3">
                      <a
                        href=""
                        className="footer__link text-water-500 dark:text-water-300 hover:text-water-700 hover:dark:text-water-200"
                      >
                        {link.name}
                      </a>
                    </li>
        ...
        <div className="footer__rights flex flex-col gap-y-6 text-center md:flex-row md:justify-between">
            ...
            <div className="footer__terms flex gap-x-6 justify-center hover:text-water-500 hover:dark:text-water-300">
              <a
                href="#"
                className="footer__terms-link text-[length:var(--small-font-size)] text-water-400 hover:dark:text-water-200"
              >
                Terms &amp; Agreements
              </a>
